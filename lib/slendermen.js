...
let animation;
let mixer;
const loader = new GLTFLoader().load('slendermen/slenderman_mad/untitled.gltf', function(result){
    ...
    slenderman.scale.set(1,1,1);
    slenderman.position.set(1,-3,3)
    slenderman.rotation.x += 90
