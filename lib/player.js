...
const senterMat = new THREE.MeshPhongMaterial({ color: 0x00ff00 });

const senter = new THREE.Mesh(senterBox, senterMat);

senter.position.set(0.25, 0.75, 0.5); // Adjust the position based on your scene
...
function animate() {
  ...
  senter.position.x = control.camera.position.x + 0.25;
  senter.position.z = control.camera.position.z - 0.5;
